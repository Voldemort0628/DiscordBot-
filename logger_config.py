...
class JSONFormatter(logging.Formatter):
    def format(self, record):
        ...
        # Add extra fields from args or kwargs
...
def log_scraping_error(url: str, error: Exception, context: Optional[Dict[str, Any]] = None):
...
def log_webhook_error(webhook_url: str, error: Exception, context: Optional[Dict[str, Any]] = None):
